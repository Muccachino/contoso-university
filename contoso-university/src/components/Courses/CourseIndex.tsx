    ...
    <>
      ...
      <div style={{margin: "0 10vw" }}>
        <div style={{margin: "50px 0 20px 50px"}}>
          <h1 style={{marginBottom: "20px"}}>Index</h1>
            ...
            {(courses as ICourse[])
              ...
              .map(course => (
                <TableRow key={course.id}>
                  ...
                  <TableCell>
                    <Link to={`/courseEdit/${course.id}`}>Edit</Link> |
                    <Link to={`/courseDetails/${course.id}`}>Details</Link> |
                    <Link to={`/courseDelete/${course.id}`}>Delete</Link>
                  </TableCell>
                </TableRow>
              ))}
          </TableBody>
